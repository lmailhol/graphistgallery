...
$admin_welcome     ="Bienvenue sur l'interface d'administration des pages de Graphist Gallery";
$admin_config_site ="Vous pouvez configurer votre site gr&acirc;ce au fichier <em>config.php</em>";
$admin_config_theme="Configurez ici les fichiers relatifs à votre thème.";
$pages_admin       ="Administrez vos pages";
...
$login_name        ="Votre nom d'utilisateur :";
$login_psw         ="Votre mot de passe :";
...
$page_codingteam   ="Page CodingTeam du projet : ";
$news              ="Page d'actualité (mise à jour, etc.) : ";
$site_projet       ="Site du projet : ";
$xmpp_projet       ="Chat xmpp du projet (via Jappix Anonymous) : ";
$documentation     ="Documentation (n'hésitez pas à la lire) : ";
$retour_site       ="Retour au site";
$info_config_site  ="<br/>Info : Vous devriez mettre l'url de votre site dans le fichier <em>config.php</em>";
$info_config_footer="<br/>Info : Vous devriez changer votre footer dans le fichier <em>config.php</em>";
$info_config_titre ="<br/>Info : Vous devriez mettre le titre de votre site dans le fichier <em>config.php</em>";
$info_config_admin ="<br/>Info : Il est déconseillé de garder le mot admin comme mot de passe ou identifiant. Pensez à le changer dans le <em>config.php</em>";
$info_modif_config ="Editez votre <em>config.php</em>";
$info_version      ="Informations sur la version :";
$version_ok        ="Cette version est la dernière version stable sortie";
$bad_version       ="Cette version ne correspond pas à la dernière version stable. Peut-être utilisez vous la version en developpement. Sinon, pensez à updater.";
$retour            ="Retour";
$modif             ="Modifier";
