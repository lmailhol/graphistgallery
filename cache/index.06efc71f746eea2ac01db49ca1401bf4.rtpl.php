        ...
        <div class="pure-u-2-3">
            <div class="l-box">
                ...
                <?php if( isset($medias) ){ ?>  
                    <?php $counter1=-1; if( isset($medias) && is_array($medias) && sizeof($medias) ) foreach( $medias as $key1 => $value1 ){ $counter1++; ?>
                        <?php if( is_img($value1)==1 ){ ?><a href="index.php?path=<?php echo $value1;?>"><img src="<?php echo $value1;?>" /></a>
                            <?php if( logged()==1 ){ ?><a href="index.php?path=<?php echo $value1;?>&amp;single_comment=edit">[Create]</a><?php } ?>
                ...
                <?php }elseif( isset($add_img_comment) AND logged()==1 ){ ?>
                    <form action="index.php?path=$add_img_comment&amp;single_comment=done" method="post">
